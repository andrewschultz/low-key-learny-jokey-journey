Version 1/220915 of Low Key Learny Jokey Journey Globals by Andrew Schultz begins here.

"This should briefly describe the purpose of Low Key Learny Jokey Journey Globals."

volume scoring flags
...
chapter game score booleans

[these are listed in approximately the order you use to get through the game, with spaces between each room where the points are scored]
...
sco-grotty-grail is a truth state that varies. [llp]
sco-potty-pail is a truth state that varies. [llp]
sco-knotty-nail is a truth state that varies.

sco-bye-bub is a truth state that varies. [llp]
...
sco-despite-dispute is a truth state that varies. [llp]

sco-flow-flue is a truth state that varies.
sco-glow-glue is a truth state that varies.
sco-go-goo is a truth state that varies. [llp]
...
sco-lore-lols is a truth state that varies. [llp]
sco-night-newt is a truth state that varies. [llp]
sco-kite-coot is a truth state that varies. [llp]
...
sco-tight-tease is a truth state that varies. [llp]
...
sco-clique-claiming is a truth state that varies. [llp]
