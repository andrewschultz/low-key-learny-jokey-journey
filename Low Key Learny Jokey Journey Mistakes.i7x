...
"pain|pane"	"p|pee"	in-bane rule	false	--	"[pain-pane]."
...
to say pain-pane:
	if the player's command includes "pain":
		say "[this-game] is nonviolent and hopefully devoid of bathroom humor";
	else:
		say "You're outside. There are no windows.";

this is the in-bane rule:
	if player is in bane be sane see, the rule succeeds;
	the rule fails;
...
"pum|pump"	"pout|out"	--	false	no-umm-out rule	"Clever sleight-of-mouth, but I can't quite allow it."
...
mist-1 (text)	mist-2 (text)	mist-rule	got-yet	leet-rule	mist-txt
"cly"	"club"	--	false	bye-bub-yet rule	"You try to go old-school finding a so-old-school-schools-didn't-exist weapon, but alas, it doesn't work."
...
"re"	"root|reroot|reroute"	--	false	--	"The free fruit dispenser is not broken. No need to start it up again.[fruit-clue]"
